...
Other examples include the parachain-heads extrinsic in AXIA and the "note-missed-proposal" extrinsic used in FRAME to determine and punish or deactivate offline validators.
